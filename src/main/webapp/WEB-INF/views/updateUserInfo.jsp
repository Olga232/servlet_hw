...
<c:choose>
	<c:when test="${result == null || result == \"\"}">
		<center>
			<h4><font color="#C0C0C0">Форма редактирования данных профиля</font></h4><br/>
		</center>
		
		<table align="left">
		<form action="user?update" method="post">
		    <tr><td>Login (email):</td><td>${sessionScope.authorizedUserLogin}</td></tr>
			<input type="hidden" name="login" value="${sessionScope.authorizedUserLogin}"/>
